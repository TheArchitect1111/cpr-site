...
export default async function AthleteOpportunitiesResourcesPage({
  params,
}: {
  ...
  return (
    <PortalSubpageLayout portalType="athlete" slug={slug} active="resources">
      <section className="pp-section">
        ...
        <h1 className="pp-section-title">Curated opportunities</h1>
        <p className="pp-section-sub">
          Scholarships, school interest, trusted partners, and CPR resources for your recruiting path.
        </p>

        {opportunities.length === 0 ? (
          <p className="pp-section-sub">No active opportunities yet. Check back as CPR tracks school interest.</p>
        ) : (
      ...
      <section className="pp-section">
        ...
        <div className="portal-hub-grid">
          {resources.slice(0, 6).map((item) => (
            <a
              key={item.id}
              href={`/portal/athlete/${slug}/resource-library`}
