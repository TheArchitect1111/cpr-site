      ...
      <section className="system-readiness">
        <div className="pm-head">
          <div>
            ...
            <p>Mike admin access, password recovery, portal credentials, Airtable schema, and PayPal payment configuration.</p>
          </div>
        ...
        {systemChecks.length > 0 ? (
          ...
          <p className="empty activity-empty">Run checks before handing the portal to Mike or after changing Vercel, Airtable, Resend, or PayPal settings.</p>
        )}
      </section>
