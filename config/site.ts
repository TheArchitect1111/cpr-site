...
export const site = {
  ...
  tribute: {
    ...
    slides: [
      { img: "/tribute/raveling-real-podium.png" },
      { img: "/tribute/raveling-real-hof.png" },
      { img: "/tribute/raveling-real-mentoring.png" },
      { img: "/tribute/raveling-june22-01.jpg" },
      { img: "/tribute/raveling-june22-02.jpg" },
      { img: "/tribute/raveling-june22-03.jpg" },
      { img: "/tribute/raveling-real-youth.png" },
      { img: "/tribute/raveling-real-dinner.png" },
    ],
  },
  cta: {
